"""
USAGE:
python simple_async.py            # attack all teams
python simple_async.py 10.32.1.2  # attack IP
python simple_async.py 1          # attack team by ID (if API has team IDs)
python simple_async.py NOP        # attack team by name (if API has team names)
"""
import asyncio
import sys
...
# Create the caching API:
api = AdCtfApiAsync("https://ctf.saarland/static/scoreboard/api/attack.json")  # or use CTF_API environment variable
